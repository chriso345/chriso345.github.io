// TODO: Refactor in own code system, as this is just an idea/prototype

// https://github.com/summbit/summbit-web-components
// Ignore errors, this is a web component

const webComponentName             = "dark-mode-switch";
...
:host {
  ...
  ${propertyDuration}: 0.2s;
  ${propertyInterpolation}: cubic-bezier(0.66, 0, 0.33, 1);
  ${propertyLightColor}: var(--light-bg);
  ${propertyDarkColor}: var(--dark-bg);
...
export default class DarkModeSwitch extends HTMLElement {
  #backgroundElement;
  #thumbElement;
  #moonElement;
  #sunElement;
...
if(!customElements.get(webComponentName)) {
  customElements.define(webComponentName, DarkModeSwitch);
}